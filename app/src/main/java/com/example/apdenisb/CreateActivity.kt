...
import com.example.apdenisb.util.*
...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode != PICK_PHOTO_CODE || resultCode != Activity.RESULT_OK || data ==null) {
            Log.w(TAG, "Did not get data back from the lunched activity, user likely canceled flow")
            return
        }
            ...
            photoReference.putBytes(imageByteArray)
                .continueWithTask { photoUploadTask ->
                    ...
                    if (!downloadUrlTask.isSuccessful){
                        ...
                        Toast.makeText(this, "Faile to upload image", Toast.LENGTH_SHORT).show()
    ...
    private fun getImageByteArray(photoUri: Uri): ByteArray {
        ...
        //quality is between 0 and 100, where 100 is no quality reduction and 0 is low quality
        scaledBitmap.compress(Bitmap.CompressFormat.JPEG, 90, byteOutputStream)
